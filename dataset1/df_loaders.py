...
def load_final():
    ...
    df_cat_order = df_aux[['year', 'stud_h', 'health']]
    df_cat_norder = df_aux[['glang','sex']]
    df_num = df_aux[['age', 'jspe', 'qcae_cog', 'qcae_aff', 'erec_mean', 'mbi_ea', 'mbi_cy']]
    df_bin = df_aux[['part', 'job', 'psyt']]
